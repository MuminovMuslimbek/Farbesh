          ...
          <div className="relative bg-white shadow-2xl p-6 rounded-xl w-[340px] h-auto">
            ...
            <form className="flex flex-col gap-4" onSubmit={(e) => e.preventDefault()}>
              ...
              >
                ...
                <option value="Po'chta">📦 Po'chta</option>
              </select>
              ...
              <button
                ...
                className={`bg-[#151513] shadow-md py-3 rounded-[12px] w-full font-semibold text-white active:scale-95 transition-all duration-300 cursor-pointer ${isLoading ? 'opacity-50 cursor-not-allowed' : ''}`}
                disabled={isLoading}
              >
